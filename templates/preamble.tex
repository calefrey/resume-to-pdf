%% source: https://github.com/ianprime0509/jsonresume-theme-latex
...
% Work
\newenvironment{work}{\section*{Experience}}{\par\pagebreak[1]}
% Arguments:
% 1. Company
% 2. Position
% 3. Date range
% 4. Location
\newenvironment{job}[4]{\quadheader{#2}{#3}{#1}{#4}}{\par\bigskip\pagebreak[1]}
...
% 3. Date range
% 4. Location
\newenvironment{position}[4]{\quadheader{#2}{#3}{#1}{#4}}{\par\bigskip\pagebreak[1]}
...
% 3. Date range
% 4. GPA
\newenvironment{school}[4]{\quadheader{#1}{#3}{#2}{#4}}{\par\bigskip\pagebreak[1]}
